...
#SBATCH --time=6-00:00:00               # time limit for the whole run, in the form of d-hh:mm:ss, also accepts mm, mm:ss, hh:mm:ss, d-hh, d-hh:mm
#SBATCH --mem=40G                       # memory required per node, in the form of [num][M|G|T]
...
source activate open_au

python AU_analysis.py -u pa121h
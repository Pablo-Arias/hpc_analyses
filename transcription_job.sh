...
############# SLURM SETTINGS #############
#SBATCH --job-name=transcription        # some descriptive job name of your choice
...
python -u transcription.py -u pa121h #-u flag is for unbuffered print statements so we can see what is happening
